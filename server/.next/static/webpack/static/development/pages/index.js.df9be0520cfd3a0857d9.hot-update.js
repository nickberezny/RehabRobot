...
function (_Component) {
  ...
  _createClass(Balance_game, [{
    ...
    value: function componentDidMount() {
      ...
      var material_mat = new three__WEBPACK_IMPORTED_MODULE_2__["MeshBasicMaterial"]({
        color: 0xffffff,
        map: column_texture
      });
      var geometry = new three__WEBPACK_IMPORTED_MODULE_2__["PlaneGeometry"](100, 50); // combine our image geometry and material into a mesh

      var mesh = new three__WEBPACK_IMPORTED_MODULE_2__["Mesh"](geometry, material_mat);
      scene.add(mesh);
      this.scene = scene;
      this.camera = camera;
...
//# sourceMappingURL=index.js.df9be0520cfd3a0857d9.hot-update.js.map