...
function (_Component) {
  ...
  _createClass(Race_game, [{
    ...
    value: function animate() {
      ...
      this.camera.position.x = this.character.position.x - 40.0 * Math.cos(this.character.rotation.z);
      this.camera.position.y = this.character.position.y - 40.0 * Math.sin(this.character.rotation.z);
...
//# sourceMappingURL=index.js.239e20c2c5912b3c4bd1.hot-update.js.map