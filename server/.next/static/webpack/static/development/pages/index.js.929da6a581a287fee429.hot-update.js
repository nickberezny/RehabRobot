  ...
  _createClass(Balance_game, [{
    ...
    value: function animate() {
      if (Math.abs(this.character.position.x) > 40) {
        ...
        if (this.character.position.y > 25) this.character.position.y -= this.v_verticle; //change player verticle position
...
//# sourceMappingURL=index.js.929da6a581a287fee429.hot-update.js.map