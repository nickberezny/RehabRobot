      ...
      */
      ...
      for (var i = 0; i < 100; i++) {
        var material = new three__WEBPACK_IMPORTED_MODULE_2__["MeshBasicMaterial"]({
          color: new three__WEBPACK_IMPORTED_MODULE_2__["Color"]().setHSL(0.3, 0.75, i / 100 * 0.4 + 0.1)
        });
        ...
        mesh.position.set(100 - 200 * Math.random(), -160 + grass_height / 2, 10);
        scene.add(mesh);
      }
...
//# sourceMappingURL=index.js.0dea3918dc69c07fcf1f.hot-update.js.map