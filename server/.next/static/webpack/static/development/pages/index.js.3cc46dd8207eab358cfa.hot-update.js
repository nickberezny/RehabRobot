...
function (_Component) {
  ...
  _createClass(Balance_game, [{
    ...
    value: function componentDidMount() {
      ...
      scene.add(ground);
      var chatacter = new three__WEBPACK_IMPORTED_MODULE_2__["Mesh"](new three__WEBPACK_IMPORTED_MODULE_2__["CircleBufferGeometry"](25, 32), characterMaterial);
    ...
    value: function animate() {
      ...
      if (Math.abs(this.character.position.x) > 40) {//ball should fall, game over
      }
...
//# sourceMappingURL=index.js.3cc46dd8207eab358cfa.hot-update.js.map