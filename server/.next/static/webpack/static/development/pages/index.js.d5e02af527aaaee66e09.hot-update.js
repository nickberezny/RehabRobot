...
function (_Component) {
  ...
  _createClass(Race_game, [{
    ...
    value: function animate() {
      ...
      this.other2.rotation.y += 0.05; //this.camera.lookAt( this.character.position );

      this.camera.rotation.z = -this.character.rotation.z / 2.0;
      this.camera.rotation.y = -this.character.rotation.z / 2.0;
      this.camera.rotation.x = this.character.rotation.z / 2.0 + 1.0;
      this.renderScene();
...
//# sourceMappingURL=index.js.d5e02af527aaaee66e09.hot-update.js.map