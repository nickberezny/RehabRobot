...
function (_Component) {
  ...
  _createClass(Balance_game, [{
    ...
    value: function componentDidMount() {
      ...
      var column = new three__WEBPACK_IMPORTED_MODULE_2__["Mesh"](new three__WEBPACK_IMPORTED_MODULE_2__["PlaneGeometry"](70, 200), column_mat);
      column.position.set(0.0, 0.0, -200);
      scene.add(column);
      this.scene = scene;
      this.camera = camera;
...
//# sourceMappingURL=index.js.d23df10a76f53182001a.hot-update.js.map