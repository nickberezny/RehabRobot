  ...
  _createClass(Balance_game, [{
    ...
    value: function animate() {
      if (Math.abs(this.character.position.x) > 40) {
        ...
        this.character.x += this.v_horizontal; //player continues to move horizontally 

        this.v_verticle += 9.8 * 0.001; //accelerate down at g

        this.character.y -= this.v_verticle; //change player verticle position
...
//# sourceMappingURL=index.js.d1dfb685b1e493374f08.hot-update.js.map