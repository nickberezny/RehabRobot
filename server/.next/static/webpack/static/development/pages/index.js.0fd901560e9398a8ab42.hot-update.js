...
function (_Component) {
  ...
  _createClass(Follow_traj, [{
    ...
    value: function animate() {
      ...
      this.props.move_object(this.character, this.theta1, 80.0, this.race_speed1);
      this.props.move_object(this.other, this.theta2, 90.0, this.race_speed2);
      this.props.move_object(this.other2, this.theta3, 70.0, this.race_speed3);
...
//# sourceMappingURL=index.js.0fd901560e9398a8ab42.hot-update.js.map