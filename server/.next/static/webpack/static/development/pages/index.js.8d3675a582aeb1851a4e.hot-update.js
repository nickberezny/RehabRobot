  ...
  _createClass(Follow_traj, [{
    ...
    value: function animate() {
      if (!this.start_game) {
        ...
        console.log(Math.round(5 - this.timer));
        ...
        this.loader.load('static/fonts/helvetiker_regular.typeface.json', function (font) {
          ...
          var text6 = new three__WEBPACK_IMPORTED_MODULE_2__["Mesh"](Geometry5, textMaterial);
          text6.position.set(-20, 0, 0);
          scene.add(text6);
        });
        if (this.timer > 4.5) this.start_game = 1;
      }
...
//# sourceMappingURL=index.js.8d3675a582aeb1851a4e.hot-update.js.map