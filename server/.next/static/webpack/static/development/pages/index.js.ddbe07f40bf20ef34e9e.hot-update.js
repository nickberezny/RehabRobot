...
function (_Component) {
  ...
  _createClass(Race_game, [{
    ...
    value: function animate() {
      ...
      this.camera.rotation.z = this.character.position.z;
      this.camera.lookAt(this.character.position); //this.camera.rotation.y = 0
...
//# sourceMappingURL=index.js.ddbe07f40bf20ef34e9e.hot-update.js.map