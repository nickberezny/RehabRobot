...
function (_Component) {
  ...
  function Test_timer(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Test_timer).call(this, props));
    _this.state = {
      date: new Date()
    };
    return _this;
  ...
  _createClass(Test_timer, [{
    ...
    value: function componentDidMount() {
      var date2 = new Date();
      this.props.setParam('x', date2 - this.date);
      this.props.setParam('xdes', date2 - this.date);
      console.log('New');
      console.log(date2);
      this.setState({
        date: new Date()
...
//# sourceMappingURL=index.js.ffc8e55710d155c651ef.hot-update.js.map