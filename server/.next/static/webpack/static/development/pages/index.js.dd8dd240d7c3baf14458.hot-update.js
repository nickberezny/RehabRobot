...
function (_Component) {
  ...
  _createClass(Race_game, [{
    ...
    value: function animate() {
      ...
      this.camera.position.x = this.character.position.x - 40.0 * Math.cos(this.character.rotation.x);
      this.camera.position.y = this.character.position.y - 40.0 * Math.sin(this.character.rotation.x);
...
//# sourceMappingURL=index.js.dd8dd240d7c3baf14458.hot-update.js.map