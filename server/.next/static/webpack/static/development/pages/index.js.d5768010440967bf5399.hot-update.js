...
function (_Component) {
  ...
  _createClass(Balance_game, [{
    ...
    value: function componentDidMount() {
      ...
      scene.add(column);
      var grass_texture = textureLoader.load("static/textures/grass_pic.jpeg");
      var grass_mat = new three__WEBPACK_IMPORTED_MODULE_2__["MeshBasicMaterial"]({
        color: 0xffffff,
        map: grass_texture
      });
      var grass = new three__WEBPACK_IMPORTED_MODULE_2__["Mesh"](new three__WEBPACK_IMPORTED_MODULE_2__["PlaneGeometry"](200, 40), column_mat);
      grass.position.set(5, -60, -200);
      scene.add(grass);
      this.scene = scene;
      this.camera = camera;
...
//# sourceMappingURL=index.js.d5768010440967bf5399.hot-update.js.map