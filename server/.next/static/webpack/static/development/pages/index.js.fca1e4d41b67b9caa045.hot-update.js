      ...
      */
      ...
      for (var i = 0; i < 400; i++) {
        var material = new three__WEBPACK_IMPORTED_MODULE_2__["MeshBasicMaterial"]({
          color: new three__WEBPACK_IMPORTED_MODULE_2__["Color"]().setHSL(0.3, 0.75, i / 400 * 0.4 + 0.1)
        });
        var grass_height = 20 * Math.random() + 10;
        var grass_geometry = new three__WEBPACK_IMPORTED_MODULE_2__["PlaneBufferGeometry"](2, grass_height);
        var mesh = new three__WEBPACK_IMPORTED_MODULE_2__["Mesh"](grass_geometry, material);
        mesh.position.set(500 - 1000 * Math.random(), -160 + grass_height / 2, 10);
...
//# sourceMappingURL=index.js.fca1e4d41b67b9caa045.hot-update.js.map