...
class Follow_traj2 extends Component {
  constructor(props) {
    super(props)
  ...
  componentDidMount() {
    ...
    var desMaterial = new THREE.MeshBasicMaterial( { color: 0x7fffa3, transparent: true, opacity: 0.7 } );
  ...
  animate() {
    ...
    if(!this.start_game)
    {
      ...
      var current_time = Math.round(5.56 - this.timer).toString()
